...
from dataloader.dataset_loader import CIFAR10_Sampled
from lib.losses import multi_reject_CrossEntropyLoss, reject_CrossEntropyLoss
from lib.experts import SyntheticExpertOverlap
from lib.dataset import load_gtsrb, ContextSampler
from utils.misc import get_logger, accuracy
...
class MetaTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.test_loader = torch.utils.data.DataLoader(test_data_trgt, batch_size=args.meta_test_batch_size, shuffle=False,
                                                  **kwargs)
        self.test_loader_val = torch.utils.data.DataLoader(test_data_trgt, batch_size=64,
                                                       shuffle=False,
                                                       **kwargs)
