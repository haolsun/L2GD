...
from models.resnet20 import resnet20Mtl
import numpy as np
...
class MtlLearner(nn.Module):
    ...
    def __init__(self, args, loss_fn, mode='meta', num_cls=64):
        ...
        if self.mode == 'meta':
            ...
            self.encoder = resnet20Mtl(norm_type=args.norm_type, mtl=True)
            ...
            self.encoder = resnet20Mtl(norm_type=args.norm_type, mtl=False)
