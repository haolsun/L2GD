...
import random
import numpy as np
from HAM10000.utils.misc import pprint
from HAM10000.utils.gpu_tools import set_gpu
from HAM10000.trainer.meta import MetaTrainer
from HAM10000.trainer.pre import PreTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='ham10000', choices=['ham10000'])  # Dataset
    ...
    parser.add_argument('--meta_classes', type=int, default=7)  # Way number, how many classes in a task
    parser.add_argument('--meta_experts', type=int, default=10)  # Way number, how many classes in a task
    ...
    parser.add_argument('--update_step', type=int, default=2)  # The number of updates for the inner loop
    ...
    parser.add_argument('--pre_classes', type=int, default=7)
    parser.add_argument('--pre_experts', type=int, default=10)
    ...
    parser.add_argument('--pre_lr', type=float, default=0.001) # Learning rate for pre-train phase
    ...
    parser.add_argument('--name', type=str, default="ham10000_34_pre")
    parser.add_argument('--n_cntx_pts', type=int, default=140)
    ...
    args.device = device
    set_seed(args.seed)
    args.meta_label = 'exp' + str(args.meta_experts) + '_depth' + str(args.depth) + '_dim' + str(args.hidden_dim)
