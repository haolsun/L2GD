...
from CIFAR100.lib.dataset import coarse2sparse
...
class SyntheticExpertPop():
    def __init__(self, class_list, n_classes=10, p_in=1.0, p_out=0.1):
        self.expert_static = True
        self.classes_oracle = class_list
