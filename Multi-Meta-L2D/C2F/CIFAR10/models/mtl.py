...
from CIFAR10.models.wideresnet_mtl import WideResNetMtl
import numpy as np
...
class MtlLearner(nn.Module):
    ...
    def __init__(self, args, loss_fn, mode='meta', num_cls=64):
        ...
        if self.mode == 'meta':
            ...
            self.encoder = WideResNetMtl(28, 3, args.pre_classes+args.pre_experts, 2, dropRate=0.0, mtl=True)
            ...
            self.encoder = WideResNetMtl(28, 3, args.pre_classes+args.pre_experts, 2, dropRate=0.0, mtl=False)
