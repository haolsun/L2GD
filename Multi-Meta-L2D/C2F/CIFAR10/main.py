...
import random
import numpy as np
from CIFAR10.utils.misc import pprint
from CIFAR10.utils.gpu_tools import set_gpu
from CIFAR10.trainer.meta import MetaTrainer
from CIFAR10.trainer.pre import PreTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='CIFAR10', choices=['CIFAR10'])  # Dataset
    ...
    parser.add_argument('--meta_batch_size', type=int, default=128)  # 元训练bz：直接抄meta-l2d的
    parser.add_argument('--meta_val_batch_size', type=int, default=8)  # Batch size for pre-train phase
    parser.add_argument('--meta_test_batch_size', type=int, default=1)
    parser.add_argument('--meta_classes', type=int, default=10)  # Way number, how many classes in a task
    parser.add_argument('--meta_experts', type=int, default=6)  # Way number, how many classes in a task
    ...
    parser.add_argument('--pre_classes', type=int, default=10)  # Way number, how many classes in a task
    ...
    parser.add_argument('--p_out', type=float, default=0.2)
    parser.add_argument('--name', type=str, default="cifar10_334_pre")
    ...
    args.meta_label = 'exp' + str(args.meta_experts) + '_depth' + str(args.depth) + '_dim' + str(args.hidden_dim)+'p'+str(args.p_out) +'_seed'+str(args.seed)
