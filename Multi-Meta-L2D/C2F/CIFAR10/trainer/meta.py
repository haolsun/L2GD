...
from CIFAR10.utils.misc import *
...
from CIFAR10.lib.losses import multi_reject_CrossEntropyLoss, reject_CrossEntropyLoss,ova
from CIFAR10.lib.experts import SyntheticExpertOverlap
from CIFAR10.lib.dataset import load_cifar, load_ham10000, load_gtsrb, ContextSampler
from CIFAR10.utils.misc import get_logger, accuracy
...
class MetaTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.cntx_sampler_val = ContextSampler(images=val_data_cntx.dataset.data[val_data_cntx.indices],
                                               ...
                                               args.dataset == 'cifar100_SC' else None,
                                               n_cntx_pts=args.n_cntx_pts, device=self.device, **kwargs)
    ...
    def train(self):
        ...
        for epoch in range(1, self.args.max_epoch + 1):
            ...
            self.evaluate(self.test_loader_val, self.cntx_sampler_test, self.experts_test)
